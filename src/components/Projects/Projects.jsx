...
import { ProjectCard2 } from "../ProjectCard/ProjectCard";
  ...
  const projects = [
    {
      ...
      description:
        "This React app allows you to search the entire back catalogue of Brewdog beers thanks to some nifty API manipulation.",
      imgUrl: projImg1,
      url: url1,
      urlExtra: urlBrew,
    },
    {
      ...
      description:
        "Commissioned by JRD Electrical Ltd to redesign their website. React, JavaScript and Sass were the order of the day!",
      imgUrl: projImg4,
      url: url2,
      urlExtra: urlElec,
    },
    {
      ...
      description:
        "Remember Snake on the Nokia 3310? Well I redesigned it using CSS, (minimal) HTML and JavaScript. Game on!",
      imgUrl: projImg2,
      url: url3,
      urlExtra: urlSnake,
    },
    {
      ...
      description:
        "An interesting desktop version of Space Invaders created with all my JavaScript and Sass know-how. The invasion has begun!",
      imgUrl: projImg3,
      url: url4,
      urlExtra: urlAlien,
    },
    {
      title: "Oh My Word",
      description:
        "What's that? A full-on clone of Wordle - the most popular word-based game around? As the kids would say: word!",
      imgUrl: projImg5,
      url: url5,
      urlExtra: urlWordle,
    },
    ...
    // },
    {
      ...
      description:
        "We love code. Even Morse Code. This little snazzy Morse Coder uses JavaScript to handle all the heavy lifting. ",
      imgUrl: projImg6,
      url: url6,
      urlExtra: urlMorse,
    },
  ...
  const projects3 = [
    {
      ...
      description:
        "Head over to my GitHub for even more projects, including ticket trackers, games and my original portfolio made from HTML and CSS.",
      imgUrl: projImg8,
      url: url8,
    },
  ];
  ...
  const projects2 = [
    {
      ...
      description:
        "I am currently working on a website for a new icecream parlour in the area called Sorella's. Watch this space...",
      imgUrl: projImg10,
      url: url10,
      urlExtra: url8,
    },
              ...
              {({ isVisible }) => (
                ...
                >
                  <div className="project-box">
                    <h2>My Work</h2>
                    <p>
                      What's a portfolio without a few examples of your work?
                      Well, not a portfolio for one. So, without further ado, I
                      present to you some of my most recent projects. Click the
                      arrow when you hover over each image to zoom over to the
                      desired project's page. Alternatively click on the Github
                      icon and you will get whisked to its GitHub page, so you
                      can check out the project's code in all its wonderful
                      glory.
                    </p>
                    <div className="logo-container">
                      <button>
                        <a
                          href="https://github.com/RenSormani"
                          target="_blank"
                          rel="noreferrer"
                        >
                          {" "}
